...
void Pice_dll::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Pice_dll::*)(qint64 , qint64 );
            if (_t _q_method = &Pice_dll::operationCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Pice_dll::operationCompleted(qint64 _t1, qint64 _t2)
{
